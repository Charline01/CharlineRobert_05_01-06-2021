    ...
    fetch(config.host + "/api/article",
        {
            ...
            "body": JSON.stringify({ favorites: getFavorites() })
        }).then(data => data.json())
                ...
                document.querySelector(".container").innerHTML += `<div class="col-12 mt-5">
                                                                        <div class="card article">
                                                                            <div class="card-header">
                                                                                <h5 class="card-title d-flex justify-content-between">${article.h2}<span class="publication-date">${article.getFormatedDate()}</span></h5>
                                                                            </div>
                                                                            <img src="${config.host}/${article.img}" class="card-img-top">
